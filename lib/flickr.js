...
const beginDate = Math.round((Date.now() / 1000) - (86400 * 0.75 * 365))
const endDate = Math.round((Date.now() / 1000) - (86400 * 0.25 * 365))
// const endDate = Math.round(beginDate + (86400 * 30))
